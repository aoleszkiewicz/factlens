...
jednostkowymi (\texttt{tests/model/}). Poniżej omawiamy najistotniejsze fragmenty.
...
poprawił się, zapamiętujemy stan wag; w przeciwnym razie zliczamy epoki bez poprawy i
przerywamy po przekroczeniu \texttt{patience}. Na końcu przywracamy najlepsze wagi.
...
(\texttt{baseline.make\_tfidf\_vectorizer}) --- to gwarantuje identyczną reprezentację
