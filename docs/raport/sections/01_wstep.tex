...
(jak pokazano dalej, klasy są w tym zbiorze silnie rozróżnialne leksykalnie), lecz w
...
Celem projektu jest zbudowanie \textbf{sieci neuronowej od zera}
...
GPU). Końcowym modelem projektu, opisanym w niniejszej dokumentacji, jest
klasyfikator \textbf{TF-IDF $\rightarrow$ MLP}.

\subsection{Zbiór danych}

Wykorzystano publiczny zbiór \emph{Fake and Real News Dataset} (Kaggle,
\texttt{clmentbisaillon/fake-and-real-news-dataset}), czyli dwa pliki CSV
